...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.singleWordLabel.text = _wordArr[indexPath.row][@"word"];
    cell.EnglishPronounceLabel.text = _wordArr[indexPath.row][@"english"];
    cell.AmericanPronounceLabel.text = _wordArr[indexPath.row][@"american"];
    cell.WordMeaningLabel.text = _wordArr[indexPath.row][@"mean"];
    cell.videoName = _wordArr[indexPath.row][@"voice"];
